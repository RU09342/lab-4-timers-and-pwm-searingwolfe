...
int main(void) {
    ...
    TA0CCTL1 = OUTMOD_7;
    TA0CCR1 = 200; //The period in microseconds that the power is ON. It's half the time, which translates to a 50% duty cycle.
    ...
    //TA0CCR1 divided by TA0CCR0 = 0.5 or 50% duty cycle.
}